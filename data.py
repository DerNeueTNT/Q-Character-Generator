...
GENERIC_PERSONALITIES: list = ["kind", "happy", "hopeful", "stressed", "depressed", "arrogant", "emotional", "intelligent", "cunning", "reliable", "honest", "deceitful", "assertive", "analytical", "dumb", "annoying", "helpful", "evil", "devoted", "patient", "brave", "determined", "frightening", "innocent", "violent", "greedy", "shy", "energetic"]
